...
[![CodeRabbit Pull Request Reviews](https://img.shields.io/coderabbit/prs/github/knowall-ai/agents-portal?label=CodeRabbit+Reviews&labelColor=171717&color=FF570A)](https://coderabbit.ai)
...
bun run test:unit      # Vitest unit tests (lib + API route logic)
